/**
 * D&D 5e Class Spell Lists
 * Maps each spellcasting class to their available spells by ID
 */
...
export const BARD_SPELLS = {
  ...
  1: [
    ...
    'silent-image', 'sleep', 'speak-with-animals', 'tashas-hideous-laughter', 'thunderwave', 'unseen-servant'
  ],
  2: [
  ...
  3: [
    ...
    'glyph-of-warding', 'hypnotic-pattern', 'leomunds-tiny-hut', 'major-image',
  ...
  6: [
    ...
    'otto-irresistible-dance', 'programmed-illusion', 'true-seeing'
  ],
  7: [
    'etherealness', 'forcecage', 'mirage-arcane', 'mordenkainens-magnificent-mansion',
    'mordenkainens-sword', 'project-image', 'regenerate', 'resurrection', 'symbol', 'teleport'
  ],
  8: [
...
export const DRUID_SPELLS = {
  ...
  8: [
    'antipathy-sympathy', 'control-weather', 'earthquake', 'feeblemind', 'sunburst', 'tsunami'
  ],
  9: [
...
export const PALADIN_SPELLS = {
  ...
  3: [
    'aura-of-vitality', 'blinding-smite', 'create-food-and-water', 'crusaders-mantle',
...
export const RANGER_SPELLS = {
  cantrips: [], // Rangers don't get cantrips (except with certain subclasses)
  1: [
...
export const WIZARD_SPELLS = {
  ...
  1: [
    ...
    'sleep', 'tashas-hideous-laughter', 'tensers-floating-disk', 'thunderwave',
  ...
  3: [
    ...
    'glyph-of-warding', 'haste', 'hypnotic-pattern', 'leomunds-tiny-hut',
  ...
  4: [
    ...
    'control-water', 'dimension-door', 'evards-black-tentacles', 'fabricate',
    'fire-shield', 'greater-invisibility', 'hallucinatory-terrain', 'ice-storm',
    'locate-creature', 'mordenkainens-faithful-hound', 'mordenkainens-private-sanctum',
    'otilukes-resilient-sphere', 'phantasmal-killer', 'polymorph', 'stone-shape',
    'stoneskin', 'wall-of-fire'
  ],
  5: [
    'animate-objects', 'bigbys-hand', 'cloudkill', 'cone-of-cold', 'conjure-elemental',
    'contact-other-plane', 'creation', 'dominate-person', 'dream', 'geas',
    'hold-monster', 'legend-lore', 'mislead', 'modify-memory', 'passwall',
    'planar-binding', 'rarys-telepathic-bond', 'scrying', 'seeming', 'telekinesis',
    'teleportation-circle', 'wall-of-force', 'wall-of-stone'
  ],
  6: [
    'arcane-gate', 'chain-lightning', 'circle-of-death', 'contingency',
    'create-undead', 'disintegrate', 'drawmijs-instant-summons', 'eyebite',
    'flesh-to-stone', 'globe-of-invulnerability', 'guards-and-wards',
    'magic-jar', 'mass-suggestion', 'move-earth', 'otilukes-freezing-sphere',
    'otto-irresistible-dance', 'programmed-illusion', 'sunbeam', 'true-seeing',
    'wall-of-ice'
  ],
  7: [
    'delayed-blast-fireball', 'etherealness', 'finger-of-death', 'forcecage',
    'mirage-arcane', 'mordenkainens-magnificent-mansion', 'mordenkainens-sword',
  ...
  9: [
    ...
    'power-word-kill', 'prismatic-wall', 'shapechange', 'time-stop', 'true-polymorph', 'weird', 'wish'
  ]
}

// Class spell list mapping
export const CLASS_SPELL_LISTS: Record<string, Record<string | number, string[]>> = {
  Bard: BARD_SPELLS,
