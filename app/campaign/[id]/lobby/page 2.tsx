                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right text-sm">
                        <div className="text-gray-400">HP: <span className="text-white">{character.current_hp}/{character.max_hp}</span></div>
                        <div className="text-gray-400">AC: <span className="text-white">{character.armor_class}</span></div>
                      </div>
                    </div>

                    <div className="grid grid-cols-6 gap-2 text-center text-sm">
                      {['STR', 'DEX', 'CON', 'INT', 'WIS', 'CHA'].map((ability, i) => {
                        const score = character[ability.toLowerCase() as keyof typeof character] as number
              ...
              <div className="mt-6">
                <PixelPanel>
                  <div className="p-6 text-center">
                    ...
                    <form action={`/api/campaign/${params.id}/start`} method="POST">
